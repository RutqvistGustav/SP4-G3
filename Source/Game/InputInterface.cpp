...
bool InputInterface::BackButton() const
{
	return (myInput->IsKeyPressed(VK_ESCAPE) || myControllerInput->IsPressed(XINPUT_GAMEPAD_B));
}
...
float InputInterface::GetLeftStickX() const
{
	return myControllerInput->GetLeftStickX();
}
